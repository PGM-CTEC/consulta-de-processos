...
| `frontend/src/components/BulkSearch.jsx` | Line 132: text-gray-400 → text-gray-600; Line 138: text-gray-400 → text-gray-600; Lines 216-220: text-gray-400 → text-gray-600 (table headers) |
